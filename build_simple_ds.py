...
def build_simple_training_ds(
    config_path, gain_noise_path, n_files, n_events_per_file, random_seed, sanity_check
):
    ...
    config_path_simple = config_path.with_name(
    ...
    tracks = build_simple_track_set(n_files, n_events_per_file, spec_length, freq_bw)
...
def build_simple_track_set(n_files, n_events_per_file, spec_length, freq_bw):
