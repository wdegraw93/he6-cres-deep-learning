...
experiment_name = "sideband_ds"
dataset_path = (
    "/media/drew/T7 Shield/cres_deep_learning/training_data/config/sideband_ds"
)
logger_path = "/home/drew/He6CRES/he6-cres-deep-learning_results/tb_logs"

cres_dm = ds.CRES_DM(root_dir=dataset_path, max_pool=16, file_max=50, batch_size=8)

# Define weights for loss function.
weights = torch.tensor([1, 10, 10]).float()
